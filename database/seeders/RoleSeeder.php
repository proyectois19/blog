...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $role2 = Role::create(['name'=>'Blogguer']);
        ...
        Permission::create(['name'=>'admin.categories.index','description'=>'Ver listado de categorias'])->syncRoles([$role1, $role2]); //bloguer ve con permiso
        ...
        Permission::create(['name'=>'admin.tags.index','description'=>'Ver Listados de Etiquetas'])->syncRoles([$role1, $role2]);
